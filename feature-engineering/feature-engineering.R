...
#' 
#' Now we will engineer Goal Difference. The **Goal Difference (GD)** is crucial in football predictive models. 
#' It is calculated as the difference between the cumulative goals scored and goals conceded by a team up to a 
#' specific match.
#' 

...
# Reading the dataset
master_dataset <- read.csv("../Bundesliga_Master_Dataset_Final_09.34.41.csv")
...
We will add two more features to our dataset - Season of the year (Spring, Autumn, Summer or Winter) and the Result of the match (Home win or Away win).

```{r}
#| label: Feature-engineering_Season_Result
...
test_df_bvb=master_dataset |> filter(HomeTeam=="Dortmund" | AwayTeam=="Dortmund") |> select(Date,HomeTeam,AwayTeam,FTHG,FTAG,HST,AST,HC,AC,HGKPP,AGKPP,HCKPP,ACKPP,HSTKPP,ASTKPP,GKPP,CKPP,STKPP,HForm,AForm,Form,HSt,HStWeighted,ASt,AStWeighted,Streak,WeightedStreak,HTGD,ATGD,GD,Season,Result)


test_df_fcb=master_dataset |> filter(HomeTeam=="Bayern Munich" | AwayTeam=="Bayern Munich") |> select(Date,HomeTeam,AwayTeam,FTHG,FTAG,HST,AST,HC,AC,HGKPP,AGKPP,HCKPP,ACKPP,HSTKPP,ASTKPP,GKPP,CKPP,STKPP,HForm,AForm,Form,HSt,HStWeighted,ASt,AStWeighted,Streak,WeightedStreak,HTGD,ATGD,GD,Season,Result)

test_df_s=master_dataset |> filter(HomeTeam=="Stuttgart" | AwayTeam=="Stuttgart") |> select(Date,HomeTeam,AwayTeam,FTHG,FTAG,HST,AST,HC,AC,HGKPP,AGKPP,HCKPP,ACKPP,HSTKPP,ASTKPP,GKPP,CKPP,STKPP,HForm,AForm,Form,HSt,HStWeighted,ASt,AStWeighted,Streak,WeightedStreak,HTGD,ATGD,GD,Season,Result)

test_df_all=master_dataset |> select(Date,HomeTeam,AwayTeam,FTHG,FTAG,HST,AST,HC,AC,HGKPP,AGKPP,HCKPP,ACKPP,HSTKPP,ASTKPP,GKPP,CKPP,STKPP,HForm,AForm,Form,HSt,HStWeighted,ASt,AStWeighted,Streak,WeightedStreak,HTGD,ATGD,GD,Season,Result)
```
